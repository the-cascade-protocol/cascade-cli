...
const snapshot = {
  _comment:
    'GENERATED by scripts/sync-knowledge-from-cascade-knowledge.mjs from cascade-knowledge data/. Do not edit: change the table upstream and re-sync. Each family carries its JSONL lines verbatim; lines.join("\\n") + "\\n" is the upstream file byte for byte and hashes to sha256. Checked by scripts/check-knowledge-drift.mjs.',
